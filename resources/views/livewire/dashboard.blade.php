                        ...
                        <div class="card card-default">
                            ...
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleFormControlPassword">Unit</label>
                                        <input type="text" class="form-control" id="exampleFormControlPassword"
                                            placeholder="Enter Unit">
                                    </div>
                                    <div class="form-footer pt-4 pt-5 mt-4 border-top">
                                        <button type="submit" class="btn btn-success btn-default float-right">Add to
                                            sell list &rarr; </button>
                                    </div>
                                </form>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <form class="horizontal-form">
                                    ...
                                    <div class="form-footer pt-5 border-top">
                                        <button type="submit"
                                            class="btn btn-success btn-default float-left">Cash</button>
                                        <button type="submit" class="btn btn-danger btn-default float-right">Without
                                            Cash</button>
                                    </div>
                                </form>
                            </div>
